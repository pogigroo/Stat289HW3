...
\oddsidemargin 0.27in % left margin (1+0.27in)
\textwidth 6.1in % text wide
\topmargin 0.2in % superior margin (1 + 0.5in)
\textheight 8.0in % text length (height)
\parindent 1em % indentation
\parskip 2ex % lines per paragraph (separation)
\usepackage[latin1]{inputenc}
\usepackage{amsfonts,amssymb,latexsym,amsmath}
\usepackage[dvips]{graphicx,color,graphics}
\usepackage[spanish]{babel}
\usepackage{multicol}
\usepackage{verbatim}
\renewcommand{\baselinestretch}{1} % line separation
