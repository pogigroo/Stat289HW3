...
% TODO replace \mboxes for distribution with macros and cleaner shortcuts
	...
	\item The parameters $\theta_i$ are independent in the prior distribution, given $\mu$ and $\tau$. As a result $\theta_i|\mu,\tau^2,\y,\si^2$ are independent and normally distributed.
	
	 Use the 1000 samples of $\mu$ and $\tau^2$ to draw 1000 samples of each $\theta_i$. Calculate the mean of each $\theta_i$ and compare to the observed treatment effects $y_i$.
